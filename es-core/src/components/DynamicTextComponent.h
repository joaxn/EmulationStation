#pragma once
#ifndef ES_CORE_COMPONENTS_DYNAMIC_TEXT_COMPONENT_H
#define ES_CORE_COMPONENTS_DYNAMIC_TEXT_COMPONENT_H
...
class DynamicTextComponent : public GuiComponent
{
public:
	DynamicTextComponent(Window* window);
	DynamicTextComponent(Window* window, const std::string& text, const std::shared_ptr<Font>& font, unsigned int color = 0x000000FF, Alignment align = ALIGN_LEFT,
